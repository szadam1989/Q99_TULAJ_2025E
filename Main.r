...
where gszr.M003 = tulaj.M003 and substr(tulaj.M003, 1, 1) between '1' and '9' and substr(gszr.M0491, 1, 2) != '23' and gszr.M0491 != '961' and gszr.M0491 != '811'
and (nvl(gszr.TOKE, -1) != nvl(tulaj.TOKE, -1) --változott a tőkéje
and (gszr.M040 not in ('0', '9')  --élő
or (gszr.M040 in ('0', '9') and to_char(gszr.M040K, 'yyyy') > '2022')) --vagy még éltek 2023-ban
